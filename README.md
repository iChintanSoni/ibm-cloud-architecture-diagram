...
> **Status:** [Roadmap](docs/09-roadmap.md) M1–M6, the M7 Library slice, and M7.1 conformance
> alignment are done; M7.2 Selection Inspector and Layers is next. The engine skeleton
...
> save/load/export all work end to end. The next milestone is the full Carbon editor chrome,
> templates, find-on-canvas, and container presets. The next vertical slice makes placed elements
> editable through Properties and navigable through Layers
> ([M7.2](docs/09-roadmap.md#m72--selection-inspector-and-layers)).
