...
- **207 bundled IBM icons** across 10 categories — searchable, offline, no network dependency.
...
icons across 10 categories. Full walkthrough in [Getting started](docs/guide/01-getting-started.md).
