...
> alignment, M7.2 Selection Inspector and Layers, and M7.3 IBM-level Templates and Frame
> Authoring are done. The engine skeleton
...
> save/load/export all work end to end. The next milestone is find-on-canvas with frame
