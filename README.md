...
> **Status:** [Roadmap](docs/09-roadmap.md) M1–M6, the M7 Library slice, M7.1 conformance
> alignment, and M7.2 Selection Inspector and Layers are done. The engine skeleton
...
> templates, find-on-canvas, and remaining editor chrome. Placed elements are now editable through
> Properties and navigable through Layers
