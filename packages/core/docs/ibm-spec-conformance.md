...
| **Node**                         | Standalone component/device                                                                                       | **Square** container — a solid category-color 48×48 tile with a 24×24 white glyph, no outline ([D25](../../../docs/decision-log.md#d25--icons-render-as-ibm-authors-them-solid-tile-white-glyph--locked)) |
...
[D24](../../../docs/decision-log.md#d24--regionvpcsubnet-are-box-only-availability-zoneon-prem-are-boundary--locked)
...
substitute for the [D17](../../../docs/decision-log.md#d17--official--ibm-internal-tool--locked) IBM Design
sign-off gate.
...
into each catalog icon ([Icon Catalog](../../catalog-build/docs/icon-catalog.md)):
...
- Connectors bind to **ports** on shapes and re-route when shapes move ([Architecture → Connectors](../../../docs/architecture.md#connectors)).
...
Design confirmation, the same posture [D21](../../../docs/decision-log.md#d21--container-presets-are-a-named-shortcut-layer-not-new-element-types--locked)
...
category only. See [Icon Catalog](../../catalog-build/docs/icon-catalog.md).

## The linter (`core/linter`)

**Advisory by default, with quick-fixes and an optional export gate** ([D12](../../../docs/decision-log.md#d12--advisory-linter--quick-fixes--optional-export-gate--locked)). It never blocks
...
Quick-fixes are ordinary [commands](../../../docs/architecture.md#command-bus--history) (`ApplyQuickFix`
wraps them), so they're undoable and also callable by the [agent API](../../mcp/docs/agent-integration.md).
...
The current implementation ships 25 rules across semantics, containment, labels, connectors, and
