...
/**
 * Renders an already-exported ICAD SVG to PNG (docs/00-decision-log.md#d35).
 *
 * `@icad/mcp`'s own `export_diagram` tool stays SVG-only and headless — real PNG export needs a
 * browser canvas the MCP server deliberately doesn't have (docs/09-roadmap.md#m91). This is the
